...
/**
 * Paints a map layer (a layer that actually consists of the whole map).
 * 
 * @author Oliver May
 */
public class MapLayerPainter implements Painter {

	private MapWidget mapWidget;

	public MapLayerPainter(MapWidget mapWidget) {
